...
If you see one of these in a disassembly you did not write, consult the [opcode reference](/docs/program-development/instruction-set) and the [bpf.wtf ISA writeup](https://bpf.wtf/sol-0x03-isa).
